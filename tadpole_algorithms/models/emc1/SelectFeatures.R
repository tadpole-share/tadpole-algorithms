...
write.csv(mydata,paste(IntermediateData,"/AgeCorrectedLongTADPOLE.csv",sep=""),row.names=FALSE)

mySubjects = read.csv(paste(IntermediateData,"/SubjectsWithChange.csv",sep=""),header=FALSE)
...
write.csv(idx_Feats-8,paste(IntermediateData,"/FeatureIndices.csv",sep=""),row.names=FALSE)