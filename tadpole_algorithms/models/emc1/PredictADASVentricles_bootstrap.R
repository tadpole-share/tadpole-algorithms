...
{
  print (i)
  str_out = paste(str_exp,"/IntermediateData/TADPOLE_Submission_EMC1_",i,".csv",sep="")
  ds = read.csv(paste(str_exp,"/IntermediateData/PatientStages_",i,".csv",sep=""),header=FALSE)
  
  mydata['DiseaseState']=ds
  #mydata['Rate']=ds$Rate
  lb2_subjects = read.csv(paste(str_exp,"ToPredict.csv",sep=""),header=FALSE)
