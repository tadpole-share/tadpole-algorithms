...
data_path_forecast_benchmark_last_visit = Path("jupyter/Outputs/benchmark_last_visit/forecast_df_d2.csv")

forecast_df_d2.to_csv(data_path_forecast_benchmark_last_visit)